...
const RatePrompt = (props) => {
  ...
  var array = ['Does not meet my expectation', 'Meets my expectation', 'Exceeds my expectation']
  ...
  return (
    <div className="fixed flex flex-col bg-[#142838] py-12 px-16 h-fit rounded-xl min-w-[30rem] max-h-[85%] overflow-auto space-y-4">
        ...
        <div className="flex flex-col text-white space-y-4 ma x-w-[28rem]">
            <h1 className="text-lg">How did the system perform compared to your expectation? </h1>
